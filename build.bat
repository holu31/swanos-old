...
i686-elf-gcc -g -I include -ffreestanding -Wall -Wextra -O0 -nostdlib -lgcc -T link.ld -o build/boot/kernel.elf bin/kernel/kernel.o bin/boot/kernel_entry.o bin/io/console.o bin/io/ports.o
